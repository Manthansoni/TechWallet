...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li><a href="../login/index.html"> <i class="ion-android-person"></i><?php session_start(); if(isset($_SESSION['name'])){echo "Hello, ".$_SESSION['name'];}else {echo "Login";} ?></a></li>
              <li class="active"><a href="../profile/profile.php">My Profile</a></li>  
    ...
    if(!$db){
      ...
      if(!$r){
          die("Please Login to see your profile");
      }
