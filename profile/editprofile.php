...
<html lang="en">
  <head>
    ...
    <title> Sign Up &middot; Unistore &middot; Responsive E-Commerce Template</title>
        ...
        <div class="container">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li><a href="../login/index.html"> <i class="ion-android-person"></i> Login </a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4 md-padding">
          <h1 class="align-center">Edit Profile</h1>
          <br>

          <form class="join" action="updatedetails.php" method="post">
            ...
            <input type="submit" name="edit" value="Update details" class="btn btn-primary">
