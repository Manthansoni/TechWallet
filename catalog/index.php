...
<html lang="en">
  ...
  <body>
    <div class="cart" data-toggle="inactive">
      <div class="label">
      <a href="../cart/index.php"><i class="ion-bag"></i></a>
      </div>
    </div>
        ...
        <div class="container">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li><a href="../login/index.html"> <i class="ion-android-person"></i> <?php if(isset($_SESSION['name'])){echo "Hello, ".$_SESSION['name'];}else {echo "Login";} ?>in </a></li>
    ...
    <div class="container">
          ...
          echo "<div class='product_wrapper'>
            <form method='post' action=''>
              <input type='hidden' name='code' value=".$row['code']." />";
                echo "<div class='image'><img src='".$row['image']."'width=\"200\"height=\"160\"'></div>";
                echo "<div class='name'>".$row['name']."</div>";
                echo "<div class='price'>$".$row['price']."</div>";
                echo "<u>Hybrid</u><br>";
                echo "<a href=surfacepro.html>Details</a><br>";
          ...
          echo "<div class='product_wrapper'>
            <form method='post' action=''>
              <input type='hidden' name='code' value=".$row['code']." />";
                ...
                echo "<div class='price'>$".$row['price']."</div>";
                echo "<u>Hybrid</u><br>";
                echo "<a href=lenovoyoga.html>Details</a><br>";
                echo  "<button type='submit' class='buy'>Add to Cart</button>
            </form>
          </div>"; 
      }
          ...
          echo "<div class='product_wrapper'>
            <form method='post' action=''>
              <input type='hidden' name='code' value=".$row['code']." />";
                ...
                echo "<div class='price'>$".$row['price']."</div>";
                echo "<u>Hybrid</u><br>";
                echo "<a href=asustransformer.html>Details</a><br>";
                echo  "<button type='submit' class='buy'>Add to Cart</button>
            </form>
          </div>"; 
      }
          ...
          echo "<div class='product_wrapper'>
            <form method='post' action=''>
              <input type='hidden' name='code' value=".$row['code']." />";
                ...
                echo "<div class='name'>".$row['name']."</div>";
                echo "<div class='price'>$".$row['price']."</div>";
                echo "<u>Smart phone</u><br>";
                echo "<a href=iphonex.html>Details</a><br>";
                echo  "<button type='submit' class='buy'>Add to Cart</button>
            </form>
          </div>"; 
      }
          ...
          echo "<div class='product_wrapper'>
            <form method='post' action=''>
              <input type='hidden' name='code' value=".$row['code']." />";
                ...
                echo "<div class='price'>$".$row['price']."</div>";
                echo "<u>Tablet</u><br>";
                echo "<a href=ipadair.html>Details</a><br>";
                echo  "<button type='submit' class='buy'>Add to Cart</button>
            </form>
          </div>"; 
      }
          ...
          echo "<div class='product_wrapper'>
            <form method='post' action=''>
              <input type='hidden' name='code' value=".$row['code']." />";
                ...
                echo "<div class='price'>$".$row['price']."</div>";
                echo "<u>Tablet</u><br>";
                echo "<a href=ipadmini.html>Details</a><br>";
                echo  "<button type='submit' class='buy'>Add to Cart</button>
            </form>
          </div>"; 
      }
          ...
          echo "<div class='product_wrapper'>
            <form method='post' action=''>
              <input type='hidden' name='code' value=".$row['code']." />";
                ...
                echo "<div class='price'>$".$row['price']."</div>";
                echo "<u>Laptop</u><br>";
                echo "<a href=hpchromebook11.html>Details</a><br>";
                echo  "<button type='submit' class='buy'>Add to Cart</button>
            </form>
          </div>"; 
      }
          ...
          echo "<div class='product_wrapper'>
            <form method='post' action=''>
              <input type='hidden' name='code' value=".$row['code']." />";
                ...
                echo "<div class='price'>$".$row['price']."</div>";
                echo "<u>Laptop</u><br>";
                echo "<a href=hpchromebook14.html>Details</a><br>";
                echo  "<button type='submit' class='buy'>Add to Cart</button>
            </form>
          </div>"; 
      }
          ...
          echo "<div class='product_wrapper'>
            <form method='post' action=''>
              <input type='hidden' name='code' value=".$row['code']." />";
                ...
                echo "<div class='price'>$".$row['price']."</div>";
                echo "<u>Laptop</u><br>";
                echo "<a href=asuschromebook.html>Details</a><br>";
                echo  "<button type='submit' class='buy'>Add to Cart</button>
            </form>
          </div>"; 
      }
      ...
      $result = mysqli_query($con,"SELECT * FROM `products` WHERE id IN (10,11,12)");
      echo "<br><br><br><br><br><br><br><br><br><br><br><br><br>";
      while($row = mysqli_fetch_assoc($result)){
