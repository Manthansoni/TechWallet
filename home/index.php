...
<html lang="en">
  ...
  <body>
                  ...
                  <div class="container">
                    <div class="row">
                      <div class="col-sm-12 align-center">
                        ...
                        <a href="../catalog/index.html">More laptops ></a>
                        <br><br>
                      </div>
                  ...
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="col-sm-12 align-center">
                        ...
                        <a href="../catalog/index.html">View surfaces ></a>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 align-center">
          ...
          <a href="../blog/index.html">Blog headlines</a>
        </div>
        <div class="col-sm-3 align-center">
        ...
        <div class="col-sm-3 align-center">
          ...
          <a href="../gallery/index.html">Products gallery</a>
        </div>
      </div>
    </div>
    <hr class="offset-lg">
    ...
    <?php
      ...
      $result = mysqli_query($con,"SELECT * FROM `products` WHERE id IN (1,2,3)");
      ...
      while($row = mysqli_fetch_assoc($result)){
          ...
          echo "<div class='image'><img src='".$row['image']."'width=\"320\"height=\"250\"'></div>";
    ...
    <div class="container">
      ...
      $result = mysqli_query($con,"SELECT * FROM `products` WHERE id IN (4,5,6,7)");
      ...
      while($row = mysqli_fetch_assoc($result)){
          ...
          echo "<div class='product_wrapper'>
              <form method='post' action=''>
              <input type='hidden' name='code' value=".$row['code']." />";
          echo "<div class='image'><img src='".$row['image']."'width=\"240\"height=\"200\"'></div>";
          echo "<div class='name'>".$row['name']."</div>";
          echo "<div class='price'>$".$row['price']."</div>";
          echo "<button type='submit' class='buy'>Add to cart</button>
              </form>
        ...
        <div class="row menu">
          <div class="col-sm-3 col-md-2">
            ...
            <div class="list-group">
              <a href="../contacts/index.html" class="list-group-item">About</a>
