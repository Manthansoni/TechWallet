    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4 md-padding">
          ...
          <form class="signin" action="../loginauth.php" method="post">
          <?php  if(isset($_SESSION['wrongpass'])){echo "<h5 style='color:red;'>".$_SESSION['wrongpass']."<h5>";}
          else {echo "Login";} ?>
          ...
          <input type="email" name="email" value="" placeholder="E-mail" required="" class="form-control" />
            ...
            <p>
              Don't have an account? Create one now! <a href="../signup/index.html"> Registration > </a>
            </p>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-4 col-md-3 align-right align-center-xs">
            ...
            <hr class="offset-sm">
            <p>TechWallet © 2020 <br> Designed By <a href="http://sunrise.ru.com/" target="_blank">Sunrise Digital</a></p>
